...
class ElectricFieldUpdate(FunctionSpec):
    ...
    _BENCHMARK_CASES = (
        ("ss-noJ-64^3", 64, False, (0, 0, 0), "scalar-scalar"),
        ("ss-J-64^3", 64, True, (-8, 7, 5), "scalar-scalar"),
        ("sf-noJ-64^3", 64, False, (0, 0, 0), "scalar-field"),
        ("sf-J-64^3", 64, True, (9, -6, 4), "scalar-field"),
        ("fs-noJ-64^3", 64, False, (0, 0, 0), "field-scalar"),
        ("fs-J-64^3", 64, True, (-5, 11, -7), "field-scalar"),
        ("ff-noJ-64^3", 64, False, (0, 0, 0), "field-field"),
        ("ff-J-64^3", 64, True, (13, -9, 6), "field-field"),
    )
