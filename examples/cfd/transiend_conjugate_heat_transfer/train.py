...
Assumes data has already been processed into ``<processed_dir>/npz`` with stats
in ``<processed_dir>/stats`` (produced by ``process_data.py``).
"""
...
from physicsnemo.utils.domino.utils import dict_to_device
