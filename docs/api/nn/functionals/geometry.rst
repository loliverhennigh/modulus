...
Generation script:
``docs/_media/functionals/geometry/mesh_poisson_disk_sample/generate.py``.

.. figure:: /nn/functional/geometry/mesh_poisson_disk_sample/mesh_poisson_modes.png
   :alt: Mesh Poisson disk sampling mode comparison
   :width: 100%

.. figure:: /nn/functional/geometry/mesh_poisson_disk_sample/mesh_poisson_modes.gif
...
Generation script:
``docs/_media/functionals/geometry/mesh_to_voxel_fraction/generate.py``.

.. figure:: /nn/functional/geometry/mesh_to_voxel_fraction/mesh_to_voxel_rotation.gif
...
slice image (right).
Generation script: ``docs/_media/functionals/geometry/sdf/generate.py``.
