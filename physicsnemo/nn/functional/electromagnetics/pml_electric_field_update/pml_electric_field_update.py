...
from ._torch_impl import pml_electric_field_update_torch
from ._warp_impl import pml_electric_field_update_warp


class PMLElectricFieldUpdate(FunctionSpec):
    """Apply PML electric correction terms to the main electric field."""
    ...
    def warp_forward(
        ...
        return pml_electric_field_update_warp(
            electric_field,
            pml_layer,
            eps,
            spacing,
    ...
    def torch_forward(
        ...
        return pml_electric_field_update_torch(
            electric_field,
            pml_layer,
            eps,
            spacing,
    ...
    def _iter_benchmark_cases(
        ...
        for idx, (label, pml_shape, offset) in enumerate(cls._CASES):
            ...
            generator.manual_seed(11011 + idx)
...
pml_electric_field_update = PMLElectricFieldUpdate.make_function(
    "pml_electric_field_update"
)


__all__ = ["PMLElectricFieldUpdate", "pml_electric_field_update"]
