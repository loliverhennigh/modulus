...
@wp.kernel
def _magnetic_field_update_kernel_mu_field_scalar(
    ...
    coeff_x = _coefficients(mu_values[0], sigma_m_scalar, dt, spacing[0])
    coeff_y = _coefficients(mu_values[1], sigma_m_scalar, dt, spacing[1])
    coeff_z = _coefficients(mu_values[2], sigma_m_scalar, dt, spacing[2])
